...
public class AppTest {
    ...
    void testGetPerson() throws Exception {
        ...
        assertThat(response.getStatus()).isEqualTo(200);
        assertThat(response.getContentType()).isEqualTo(MediaType.APPLICATION_JSON.toString());
        assertThat(response.getContentAsString()).contains("John", "Smith", "1");
    }
    ...
    void testPatchPerson() throws Exception {
        MockHttpServletResponse responsePatch = mockMvc
                .perform(
                        patch("/people/1")
                                .contentType(MediaType.APPLICATION_JSON)
                                .content("{\"firstName\": \"Alex\", \"lastName\": \"Noname\"}")
                )
                .andReturn()
                .getResponse();
        ...
        assertThat(responseGet.getContentAsString()).contains("Alex", "Noname", "1");
    ...
    void testDeletePerson() throws Exception {
        ...
        assertThat(responseGet.getStatus()).isEqualTo(200);
        assertThat(responseGet.getContentAsString()).doesNotContain("John", "Smith", "1");
    }
}
